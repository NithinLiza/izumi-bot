...
module.exports = {
  ...
  CAPTION: process.env.CAPTION || "Made with ʟɪᴢᴀ❄️",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "ᴍᴜᴅɪʏᴀɴ",
  BOT_NAME: process.env.BOT_NAME || "ʟɪᴢᴀᴍᴡᴏʟ-ᴍᴅ",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "ʟɪᴢᴀᴍᴡᴏʟ-ᴍᴅ,mudiyan",
  AUDIO_DATA: process.env.AUDIO_DATA || "ᴍᴜᴅɪʏᴀɴ;ʟɪᴢᴀᴍᴡᴏʟ-ᴍᴅ;https://files.catbox.moe/8nhlo0.jpg",
  PROCESSNAME: process.env.PROCESSNAME || "ʟɪᴢᴀᴍᴡᴏʟ-ᴍᴅ",
  AUTHOR: process.env.AUTHOR || "ᴍᴜᴅɪʏᴀɴ",
